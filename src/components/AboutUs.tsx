...
export default function AboutUs() {
    return (
        <div id="about" className="pt-[40px] md:pt-[140px] pb-[40px]">
            <div className="xl:max-w-[1320px] mx-auto">
                <div className="md:flex md:justify-between md:items-center md:gap-[50px]">
                    <div className="mb-[25px] md:mb-0 md:order-2 md:w-[50%]">
                        ...
                        <img src={about} alt="about" className="w-[283px] h-[283px] sm:w-[352px] sm:h-[352px] lg:w-[336px] lg:h-[336px] xl:w-[500px] xl:h-[500px] mx-auto"/>
                    </div>
