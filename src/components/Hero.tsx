                ...
                <div className="w-full md:w-1/2">
                    <div className="relative w-fit mx-auto md:mx-0">
                        <h1 className="inline-block w-[220px] md:w-[217px] lg:w-[290px] xl:w-[386px] sm:w-full text-center md:text-left text-[24px] md:text-[36px] lg:text-[48px] xl:text-[64px] md:leading-[45px] lg:leading-[64px] xl:leading-[80px] font-semibold">
                            Learn <span className="hidden md:inline-block text-transparent w-9 lg:w-12 xl:w-14"/> Any <span className="inline-block sm:hidden text-transparent w-1"/> Foreign Language
                        </h1>
                    ...
                    <button className="block sm:w-[305px] md:w-[236px] lg:w-[292px] xl:w-[380px] mx-auto md:mx-0 mt-[35px] xl:mt-[60px] w-full bg-[#263238] text-white rounded-[5px] xl:rounded-[15px] py-[18px] lg:py-[22px] xl:py-[32px] md:text-[18px] lg:text-[24px] xl:text-[32px]">
                        Get started
                    </button>
                </div>
